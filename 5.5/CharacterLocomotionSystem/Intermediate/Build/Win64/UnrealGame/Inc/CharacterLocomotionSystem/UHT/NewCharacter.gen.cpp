...
static const FName NAME_ANewCharacter_AddAndUpdateCustomAdvancedWarpTargets = FName(TEXT("AddAndUpdateCustomAdvancedWarpTargets"));
void ANewCharacter::AddAndUpdateCustomAdvancedWarpTargets()
{
	UFunction* Func = FindFunctionChecked(NAME_ANewCharacter_AddAndUpdateCustomAdvancedWarpTargets);
	...
	{
		AddAndUpdateCustomAdvancedWarpTargets_Implementation();
	}
}
...
static const FName NAME_ANewCharacter_CanCustomAdvancedMovement = FName(TEXT("CanCustomAdvancedMovement"));
bool ANewCharacter::CanCustomAdvancedMovement()
{
	UFunction* Func = FindFunctionChecked(NAME_ANewCharacter_CanCustomAdvancedMovement);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		return CanCustomAdvancedMovement_Implementation();
	}
}
...
static const FName NAME_ANewCharacter_CanCustomExtendedMovement = FName(TEXT("CanCustomExtendedMovement"));
bool ANewCharacter::CanCustomExtendedMovement()
{
	UFunction* Func = FindFunctionChecked(NAME_ANewCharacter_CanCustomExtendedMovement);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		return CanCustomExtendedMovement_Implementation();
	}
}
...
static const FName NAME_ANewCharacter_CustomAdvancedMovementPhysics = FName(TEXT("CustomAdvancedMovementPhysics"));
void ANewCharacter::CustomAdvancedMovementPhysics(float deltaTime, int32 Iterations)
{
	UFunction* Func = FindFunctionChecked(NAME_ANewCharacter_CustomAdvancedMovementPhysics);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		CustomAdvancedMovementPhysics_Implementation(deltaTime, Iterations);
	}
}
...
static const FName NAME_ANewCharacter_CustomExtendedMovementPhysics = FName(TEXT("CustomExtendedMovementPhysics"));
void ANewCharacter::CustomExtendedMovementPhysics(float deltaTime, int32 Iterations)
{
	UFunction* Func = FindFunctionChecked(NAME_ANewCharacter_CustomExtendedMovementPhysics);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		CustomExtendedMovementPhysics_Implementation(deltaTime, Iterations);
	}
}
...
static const FName NAME_ANewCharacter_EnterCustomAdvancedMovement = FName(TEXT("EnterCustomAdvancedMovement"));
void ANewCharacter::EnterCustomAdvancedMovement()
{
	UFunction* Func = FindFunctionChecked(NAME_ANewCharacter_EnterCustomAdvancedMovement);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	ProcessEvent(Func,NULL);
	}
	...
	{
		EnterCustomAdvancedMovement_Implementation();
	}
}
...
static const FName NAME_ANewCharacter_EnterCustomExtendedMovement = FName(TEXT("EnterCustomExtendedMovement"));
void ANewCharacter::EnterCustomExtendedMovement()
{
	UFunction* Func = FindFunctionChecked(NAME_ANewCharacter_EnterCustomExtendedMovement);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	ProcessEvent(Func,NULL);
	}
	...
	{
		EnterCustomExtendedMovement_Implementation();
	}
}
...
static const FName NAME_ANewCharacter_ExitCustomAdvancedMovement = FName(TEXT("ExitCustomAdvancedMovement"));
void ANewCharacter::ExitCustomAdvancedMovement()
{
	UFunction* Func = FindFunctionChecked(NAME_ANewCharacter_ExitCustomAdvancedMovement);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	ProcessEvent(Func,NULL);
	}
	...
	{
		ExitCustomAdvancedMovement_Implementation();
	}
}
...
static const FName NAME_ANewCharacter_ExitCustomExtendedMovement = FName(TEXT("ExitCustomExtendedMovement"));
void ANewCharacter::ExitCustomExtendedMovement()
{
	UFunction* Func = FindFunctionChecked(NAME_ANewCharacter_ExitCustomExtendedMovement);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	ProcessEvent(Func,NULL);
	}
	...
	{
		ExitCustomExtendedMovement_Implementation();
	}
}
...
static const FName NAME_ANewCharacter_GetClimbUpData = FName(TEXT("GetClimbUpData"));
UClimbUpPrimaryDataAsset* ANewCharacter::GetClimbUpData()
{
	UFunction* Func = FindFunctionChecked(NAME_ANewCharacter_GetClimbUpData);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		return GetClimbUpData_Implementation();
	}
}
...
static const FName NAME_ANewCharacter_GetCustomAdvancedMovementData = FName(TEXT("GetCustomAdvancedMovementData"));
UAdvancedMovementPrimaryDataAsset* ANewCharacter::GetCustomAdvancedMovementData() const
{
	UFunction* Func = FindFunctionChecked(NAME_ANewCharacter_GetCustomAdvancedMovementData);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
		NewCharacter_eventGetCustomAdvancedMovementData_Parms Parms;
		const_cast<ANewCharacter*>(this)->ProcessEvent(Func,&Parms);
		return Parms.ReturnValue;
	}
	else
	{
		return const_cast<ANewCharacter*>(this)->GetCustomAdvancedMovementData_Implementation();
	}
}
...
static const FName NAME_ANewCharacter_GetMantleData = FName(TEXT("GetMantleData"));
UMantlePrimaryDataAsset* ANewCharacter::GetMantleData()
{
	UFunction* Func = FindFunctionChecked(NAME_ANewCharacter_GetMantleData);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		return GetMantleData_Implementation();
	}
}
...
static const FName NAME_ANewCharacter_GetMaxCustomAdvancedSpeed = FName(TEXT("GetMaxCustomAdvancedSpeed"));
float ANewCharacter::GetMaxCustomAdvancedSpeed()
{
	UFunction* Func = FindFunctionChecked(NAME_ANewCharacter_GetMaxCustomAdvancedSpeed);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		return GetMaxCustomAdvancedSpeed_Implementation();
	}
}
...
static const FName NAME_ANewCharacter_GetMaxCustomExtendedAcceleration = FName(TEXT("GetMaxCustomExtendedAcceleration"));
float ANewCharacter::GetMaxCustomExtendedAcceleration()
{
	UFunction* Func = FindFunctionChecked(NAME_ANewCharacter_GetMaxCustomExtendedAcceleration);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		return GetMaxCustomExtendedAcceleration_Implementation();
	}
}
...
static const FName NAME_ANewCharacter_GetMaxCustomExtendedDeceleration = FName(TEXT("GetMaxCustomExtendedDeceleration"));
float ANewCharacter::GetMaxCustomExtendedDeceleration()
{
	UFunction* Func = FindFunctionChecked(NAME_ANewCharacter_GetMaxCustomExtendedDeceleration);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		return GetMaxCustomExtendedDeceleration_Implementation();
	}
}
...
static const FName NAME_ANewCharacter_GetMaxCustomExtendedSpeed = FName(TEXT("GetMaxCustomExtendedSpeed"));
float ANewCharacter::GetMaxCustomExtendedSpeed()
{
	UFunction* Func = FindFunctionChecked(NAME_ANewCharacter_GetMaxCustomExtendedSpeed);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		return GetMaxCustomExtendedSpeed_Implementation();
	}
}
...
static const FName NAME_ANewCharacter_GetVaultData = FName(TEXT("GetVaultData"));
UVaultPrimaryDataAsset* ANewCharacter::GetVaultData()
{
	UFunction* Func = FindFunctionChecked(NAME_ANewCharacter_GetVaultData);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		return GetVaultData_Implementation();
	}
}
...
static const FName NAME_ANewCharacter_StartCustomAdvancedMovement = FName(TEXT("StartCustomAdvancedMovement"));
bool ANewCharacter::StartCustomAdvancedMovement()
{
	UFunction* Func = FindFunctionChecked(NAME_ANewCharacter_StartCustomAdvancedMovement);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		return StartCustomAdvancedMovement_Implementation();
	}
}
...
static const FName NAME_ANewCharacter_StartCustomExtendedMovement = FName(TEXT("StartCustomExtendedMovement"));
bool ANewCharacter::StartCustomExtendedMovement()
{
	UFunction* Func = FindFunctionChecked(NAME_ANewCharacter_StartCustomExtendedMovement);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		return StartCustomExtendedMovement_Implementation();
	}
}
...
static const FName NAME_ANewCharacter_StopCustomAdvancedMovement = FName(TEXT("StopCustomAdvancedMovement"));
void ANewCharacter::StopCustomAdvancedMovement()
{
	UFunction* Func = FindFunctionChecked(NAME_ANewCharacter_StopCustomAdvancedMovement);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	ProcessEvent(Func,NULL);
	}
	...
	{
		StopCustomAdvancedMovement_Implementation();
	}
}
...
static const FName NAME_ANewCharacter_StopCustomExtendedMovement = FName(TEXT("StopCustomExtendedMovement"));
void ANewCharacter::StopCustomExtendedMovement()
{
	UFunction* Func = FindFunctionChecked(NAME_ANewCharacter_StopCustomExtendedMovement);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	ProcessEvent(Func,NULL);
	}
	...
	{
		StopCustomExtendedMovement_Implementation();
	}
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_NewPlugin___5_5_CharacterLocomotionSystem_HostProject_Plugins_CharacterLocomotionSystem_Source_CharacterLocomotionSystem_Public_NewCharacter_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ANewCharacter, ANewCharacter::StaticClass, TEXT("ANewCharacter"), &Z_Registration_Info_UClass_ANewCharacter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ANewCharacter), 535733908U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_NewPlugin___5_5_CharacterLocomotionSystem_HostProject_Plugins_CharacterLocomotionSystem_Source_CharacterLocomotionSystem_Public_NewCharacter_h_161694242(TEXT("/Script/CharacterLocomotionSystem"),
	Z_CompiledInDeferFile_FID_NewPlugin___5_5_CharacterLocomotionSystem_HostProject_Plugins_CharacterLocomotionSystem_Source_CharacterLocomotionSystem_Public_NewCharacter_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_NewPlugin___5_5_CharacterLocomotionSystem_HostProject_Plugins_CharacterLocomotionSystem_Source_CharacterLocomotionSystem_Public_NewCharacter_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
